...
from inceptionv3_ninapro import *
...
with open('DB1_inceptionv3_b2.json') as json_file:
    config_data = json.load(json_file)

MODEL_WEIGHTS_SAVE_FILE = os.path.abspath(
        'models_inceptionv3') +  '/'+'_DB1_inceptionv3'+ '_{}.h5'

MODEL_SAVE_FILE = os.path.abspath(
            'models_inceptionv3') +  '/'+'_DB1_inceptionv3'+  '_{}.json'
