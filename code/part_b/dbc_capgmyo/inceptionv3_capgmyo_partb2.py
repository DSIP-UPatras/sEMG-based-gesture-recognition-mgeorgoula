...
with open('Capgmyo_inceptionv3_b2.json') as json_file:
    config_data = json.load(json_file)

MODEL_WEIGHTS_SAVE_FILE = os.path.abspath(
        'models_inceptionv3_capgmyo') + '/' + '_Capgmyo_inceptionv3_'+ '_{}.h5'

MODEL_SAVE_FILE = os.path.abspath(
            'models_inceptionv3_capgmyo') +'/' + '_Capgmyo_inceptionv3_'+ + '_{}.json'
