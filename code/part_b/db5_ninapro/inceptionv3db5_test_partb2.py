...
"""PART B2 : Input random noise to column of emg data"""
...
with open('DB5_inceptionv3_b2.json') as json_file:
    config_data = json.load(json_file)

MODEL_WEIGHTS_SAVE_FILE = os.path.abspath(
        'models_inceptionv3_db5') + '/'+'_DB5_inceptionv3'+ '_{}.h5'

MODEL_SAVE_FILE = os.path.abspath(
            'models_inceptionv3_db5') + '/'+'_DB5_inceptionv3'+  '_{}.json'
