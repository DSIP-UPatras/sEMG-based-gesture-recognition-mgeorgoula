...
def VGG16_NinaProDB5(input_shape,classes, dropout_rate=0,dense1=0,dense2=0,batch_norm=False):
    ...
    model = Model(inputs=x_input,outputs=x ,name='VGG16_DB5_NinaPro')
    model.summary()
