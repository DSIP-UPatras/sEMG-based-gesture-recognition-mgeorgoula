# -*- coding: utf-8 -*-
"""
Created on Sat Nov 17 18:09:27 2018
...
folder_s = r'C:\Users\Marina\Desktop\ninapro-db5'
folder_t = 'Ninapro-DB5_Preprocessed'
subjects_num = 11
rep_index = 16
sti_index = 17
gro_index = 18
for s in range(1,subjects_num):
	for e in range(1,4):
		file = '{}/S{}_E{}_A1.mat'.format(folder_s,s,e);
