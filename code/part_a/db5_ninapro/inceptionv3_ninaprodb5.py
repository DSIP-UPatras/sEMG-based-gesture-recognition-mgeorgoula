# -*- coding: utf-8 -*-
"""
Modify InceptionV3 -DB5 NinaPro
"""
...
def InceptionV3_NinaProDB5(input_shape, classes, dropout_rate=0.,dense1=0,dense2=0,
                        dense3=0,batch_norm=False):
    ...
    model = Model(x_input, x ,name='Inceptionv3_DB5_NinaPro')
    
    #Freeze only first convolutional layer
