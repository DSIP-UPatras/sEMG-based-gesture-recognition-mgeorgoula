# -*- coding: utf-8 -*-
"""Train customized InceptionV3 model - DB5 NINAPRO - A EXERCISE """
...
from inceptionv3_ninaprodb5 import *
...
with open('DB5_inceptionv3.json') as json_file:
    config_data = json.load(json_file)



MODEL_SAVE_FILE = os.path.abspath(
        'models_inceptionv3_db5') + os.sep + '_' + config_data['model']['save_file'] + '_{}.json'
MODEL_WEIGHTS_SAVE_FILE = os.path.abspath(
        'models_inceptionv3_db5') + os.sep +  '_' + config_data['model']['save_file'] + '_{}.h5'


LOG_FILE = os.path.abspath(
        'logs_inceptionv3_db5') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.log'
LOG_TESNORBOARD_FILE = os.path.abspath(
        'tensorboardlogs_inceptionv3_db5') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file']

METRICS_SAVE_FILE = os.path.abspath(
        'metrics_inceptionv3_db5') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.mat'
...
PARAMS_TRAIN_GENERATOR['preprocess_function'] = [preprocessing_db5.lpf]
PARAMS_TRAIN_GENERATOR['preprocess_function_extra'] = [{'fs':200}]
PARAMS_TRAIN_GENERATOR['data_type'] = 'rms'
PARAMS_TRAIN_GENERATOR['classes'] = [i for i in range(13)]

PARAMS_VALID_GENERATOR['preprocess_function'] = [preprocessing_db5.lpf]
PARAMS_VALID_GENERATOR['preprocess_function_extra'] = [{'fs':200}]
