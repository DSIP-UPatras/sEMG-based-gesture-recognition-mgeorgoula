# -*- coding: utf-8 -*-
"""Train customized VGG19 - DB5 NINAPRO - A EXERCISE"""
...
with open('DB5_vgg19.json') as json_file:
    config_data = json.load(json_file)



MODEL_SAVE_FILE = os.path.abspath(
        'models_vgg19_db5') + os.sep +  '_' + config_data['model']['save_file'] + '_{}.json'
MODEL_WEIGHTS_SAVE_FILE = os.path.abspath(
        'models_vgg19_db5') + os.sep + '_' + config_data['model']['save_file'] + '_{}.h5'


LOG_FILE = os.path.abspath(
        'logs_vgg19_db5') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.log'
LOG_TESNORBOARD_FILE = os.path.abspath(
 'tensorboardlogs_vgg19_db5') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file']

METRICS_SAVE_FILE = os.path.abspath(
    'metrics_vgg19_db5') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.mat'
...
for i in range(0,11):                   #Freeze 9 first layers for VGG19
