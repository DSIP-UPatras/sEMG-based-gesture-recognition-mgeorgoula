# -*- coding: utf-8 -*-
"""Train customized ResNet50 - DB5 NINAPRO - A EXERCISE"""
...
from resnet50_ninaprodb5 import *
...
with open('DB5_resnet50.json') as json_file:
    config_data = json.load(json_file)



MODEL_SAVE_FILE = os.path.abspath(
        'models_resnet50_db5') + os.sep +  '_' + config_data['model']['save_file'] + '_{}.json'
MODEL_WEIGHTS_SAVE_FILE = os.path.abspath(
        'models_resnet50_db5') + os.sep + '_' + config_data['model']['save_file'] + '_{}.h5'


LOG_FILE = os.path.abspath(
        'logs_resnet50_db5') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.log'
LOG_TESNORBOARD_FILE = os.path.abspath(
 'tensorboardlogs_resnet50_db5') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file']

METRICS_SAVE_FILE = os.path.abspath(
    'metrics_resnet50_db5') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.mat'
...
for i in range(0,2):                   #Freeze 50 first layers of Resnet50
