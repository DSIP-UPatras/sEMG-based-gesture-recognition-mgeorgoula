...
"""Train customized Resnet50 model - DB1 NINAPRO - A EXERCISE """
...
from resnet50_db1ninapro import *
...
with open('DB1_resnet50.json') as json_file:
    config_data = json.load(json_file)


MODEL_WEIGHTS_SAVE_FILE = os.path.abspath('drive/Thesis_emg'+'/'+
        'models_resnet50') + os.sep + '_' + config_data['model']['save_file'] + '_{}.h5'

LOG_FILE = os.path.abspath('drive/Thesis_emg'+'/'+
        'logs_resnet50') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.log'
LOG_TESNORBOARD_FILE = os.path.abspath('drive/Thesis_emg'+'/'+
        'tensorboardlogs_resnet50') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file']


MODEL_SAVE_FILE = os.path.abspath('drive/Thesis_emg'+'/'+
            'models_resnet50') + os.sep + '_' + config_data['model']['save_file'] + '_{}.json'

METRICS_SAVE_FILE = os.path.abspath('drive/Thesis_emg'+'/'+
    'metrics_resnet50') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.mat'
...
for i in range(0,2):           #Freeze 80 layers of Resnet50
