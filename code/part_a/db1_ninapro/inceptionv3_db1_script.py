...
"""Train customized InceptionV3 - DB1 NINAPRO - A EXERCISE""" 
...
from inceptionv3_db1_ninapro import *
...
with open('DB1_inceptionv3.json') as json_file:
    config_data = json.load(json_file)


LOG_FILE = os.path.abspath(
        'logs_inceptionv3') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.log'
LOG_TESNORBOARD_FILE = os.path.abspath(
        'tensorboardlogs_inceptionv3') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file']

MODEL_SAVE_FILE = os.path.abspath(
        'models_inceptionv3') + os.sep + TIMESTAMP + '_' + config_data['model']['save_file'] + '_{}.json'
        
MODEL_WEIGHTS_SAVE_FILE = os.path.abspath(
        'models_inceptionv3') + os.sep + TIMESTAMP + '_' + config_data['model']['save_file'] + '_{}.h5'

METRICS_SAVE_FILE = os.path.abspath(
    'metrics_inceptionv3') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.mat'
...
for i in range(0,9):                   #Freeze 9 first layers for Inceptionv3
