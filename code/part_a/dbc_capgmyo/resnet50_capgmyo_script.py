# -*- coding: utf-8 -*-
"""Train customized ResNet50 - DBc CapgMyo """
...
with open('Capgmyo_resnet50.json') as json_file:
    config_data = json.load(json_file)


LOG_FILE = os.path.abspath(
        'logs_resnet50_capgmyo') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.log'

MODEL_SAVE_FILE = os.path.abspath(
        'models_resnet50_capgmyo') + os.sep +  '_' + config_data['model']['save_file'] + '_{}.json'
MODEL_WEIGHTS_SAVE_FILE = os.path.abspath(
        'models_resnet50_capgmyo') + os.sep +  '_' + config_data['model']['save_file'] + '_{}.h5'

METRICS_SAVE_FILE = os.path.abspath(
    'metrics_resnet50_capgmyo') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.mat'

 
LOG_TESNORBOARD_FILE = os.path.abspath(
        'tensorboardlogs_resnet50_capgmyo') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file']
...
for i in range(0,2):                   #Freeze 80 first layers of ResNet50
