# -*- coding: utf-8 -*-
"""Train customized InceptionV3 - DBc CapgMyo """
...
from utils_capgmyo import *
from generator_capgmyo import *
from inceptionv3_capgmyo import *
...
with open('Capgmyo_inceptionv3.json') as json_file:
    config_data = json.load(json_file)


LOG_FILE = os.path.abspath(
        'logs_inceptionv3_capgmyo') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.log'

MODEL_SAVE_FILE = os.path.abspath(
        'models_inceptionv3_capgmyo') + os.sep +  '_' + config_data['model']['save_file'] + '_{}.json'
MODEL_WEIGHTS_SAVE_FILE = os.path.abspath(
        'models_inceptionv3_capgmyo') + os.sep +  '_' + config_data['model']['save_file'] + '_{}.h5'

METRICS_SAVE_FILE = os.path.abspath(
    'metrics_rinceptionv3_capgmyo') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.mat'

 
LOG_TESNORBOARD_FILE = os.path.abspath(
        'tensorboardlogs_inceptionv3_capgmyo') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file']
...
input_directory = r'C:\Users\Marina\Desktop\CAPGMYO\CAPGMYO-Preprocessed'
#input_directory = r'drive/Thesis_emg/CAPGMYO-Preprocessed'
#input_directory = r'drive/Thesis_emg/Capgmyo_dbc_preprocessed'
PARAMS_TRAIN_GENERATOR['preprocess_function'] = [preprocessing_capgmyo.lpf]
PARAMS_TRAIN_GENERATOR['preprocess_function_extra'] = [{'fs':1000}]
PARAMS_TRAIN_GENERATOR['classes'] = [i for i in range(12)]

PARAMS_VALID_GENERATOR['preprocess_function'] = [preprocessing_capgmyo.lpf]
PARAMS_VALID_GENERATOR['preprocess_function_extra'] = [{'fs':1000}]
PARAMS_VALID_GENERATOR['classes'] = [i for i in range(12)]
...
for i in range(0,2):                   #Freeze 9 first layers of Inceptionv3
