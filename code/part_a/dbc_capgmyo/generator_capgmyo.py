...
"""Image data generator for DBc CapgMyo"""
...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, trials, input_directory, batch_size=32, sample_weight=False, dim=(8,16,3),
                 classes=2, shuffle=True, preprocess_function=None,preprocess_function_extra=None,
                 partb_zero =False, partb_noise=False,
                 zero_column1=0, noise_column1 = 0,noise_column2 = 0,zero_column2=0,
