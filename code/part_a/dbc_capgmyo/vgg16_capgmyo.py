...
def VGG16_Capgmyo(input_shape,classes,dropout_rate=0,dense1=0,dense2=0,dense3=0, batch_norm=False):

     #Load pretrained vgg16 model
    vgg16_model= vgg16.VGG16(weights='imagenet', include_top=False)
   
    #Keep 10/26 layers of original vgg16 model
    ...
    model = Model(inputs=x_input,outputs=x ,name='VGG16_Capgmyo')
    model.summary()
