# -*- coding: utf-8 -*-
"""Train customized VGG16 - DBc CapgMyo """
...
with open('Capgmyo_vgg16.json') as json_file:
    config_data = json.load(json_file)


LOG_FILE = os.path.abspath(
        'logs_capgmyo') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.log'

MODEL_SAVE_FILE = os.path.abspath(
        'models_vgg16_capgmyo') + os.sep +  '_' + config_data['model']['save_file'] + '_{}.json'
MODEL_WEIGHTS_SAVE_FILE = os.path.abspath(
        'models_vgg16_capgmyo') + os.sep +  '_' + config_data['model']['save_file'] + '_{}.h5'

METRICS_SAVE_FILE = os.path.abspath(
    'metrics_capgmyo') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file'] + '.mat'

 
LOG_TESNORBOARD_FILE = os.path.abspath(
        'tensorboardlogs_capgmyo') + os.sep + TIMESTAMP + '_' + config_data['logging']['log_file']
...
SUBJECTS = config_data.get('subjects', [i for i in range(1, 10)])
...
for i in range(0,11):                   #Freeze 10 first layers of VGG16
